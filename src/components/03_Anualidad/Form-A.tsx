    ...
    return (
        <>
            ...
            [&>div>input]:rounded-md [&>div>input]:p-2 " >
                <InputControl labelName="Capital" inputName="capital" handleInputChange={handleInputChange} value={state.capital} type={""} className="rounded-md p-2" />
                <InputControl labelName="Tasa de Interés (%)" inputName="interes" handleInputChange={handleInputChange} value={state.interes} type={""}  className="rounded-md p-2"/>
                <InputControl labelName="Periodos" inputName="tiempo" handleInputChange={handleInputChange} value={state.tiempo} type={""}  className="rounded-md p-2"/>
                <div>
